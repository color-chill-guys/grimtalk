...
## 강사 시점
### 로그인
![강사 로그인](GIF 모음집/강사 입장/001_로그인_강사.gif)
### 내 강의 페이지
![강사 강의 페이지](GIF 모음집/강사 입장/002_강의접속_강사.gif)
### 질문 답변
![강사 질문 답변](GIF 모음집/강사 입장/003_질문답변_강사.gif)
### 라이브 시작
![강사 라이브 시작](GIF 모음집/강사 입장/004_라이브시작_강사.gif)
### 라이브 강의
![강사 라이브 강의](GIF 모음집/강사 입장/005_라이브강의_강사.gif)
### 다시보기
![강사 다시보기](GIF 모음집/강사 입장/006_다시보기_강사.gif)

---
## 수강생 시점
### 로그인
![수강생 로그인](GIF 모음집/수강생 입장/001_로그인_수강생.gif)
### 강의 조회 & 구독 & 즐겨찾기
![수강생 강의 조회 & 구독 & 즐겨찾기](GIF 모음집/수강생 입장/002_인기강의_원하는강의_수강생.gif)
### 라이브 입장
![수강생 라이브 입장](GIF 모음집/수강생 입장/003_라이브_입장_수강생.gif)
### 라이브 기능
![수강생 라이브 기능](GIF 모음집/수강생 입장/004_라이브기능_수강생.gif)
### AI 그림 비교
![수강생 AI 그림 비교](GIF 모음집/수강생 입장/005_AI그림비교_수강생.gif)
### 다시보기
![수강생 다시보기](GIF 모음집/수강생 입장/006_다시보기_수강생.gif)
### 리뷰 작성
![수강생 리뷰 작성](GIF 모음집/수강생 입장/007_리뷰작성_수강생.gif)
